...
Complementary to the previous approach, GSEA consists in analyzing how annotations are distributed as a function of an enrichment score.
...
<div class="alert alert-info">
Re-run the analysis using the GO MF gene set. What differentiate GSEA from our previous annotation enrichment analysis? Can we make both analysis match?
</div>
