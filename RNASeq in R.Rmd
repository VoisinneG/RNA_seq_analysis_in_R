...
idx_remove <- which(! names(seqdata) %in% sampleinfo$sample.id)
...
Download the gene set file from <a href = "http://software.broadinstitute.org/gsea/msigdb/collections.jsp">here</a>. Several sets can be dowloaded. We choose the Hallmark gene sets with "gene symbols" and save it in `./data`. You should now have a file `h.all.v6.2.symbols.gmt` in the `./data` folder. Let's read it:
